      ...
      <section>
            ...
            <div class="flex items-start">
              <div class="w-full md:w-1/2 lg:pr-20">
                <h1 class="mb-6 text-4xl font-bold leading-tight md:text-6xl">
                  <i class="mr-4 fas fa-shield-alt"></i>Realice compras, tratos y trabajos de forma segura
                </h1>
                <p class="mb-8 text-lg opacity-90 animate-fade-right">Comunidad colaborativa contra estafas y fraudes
                  digitales</p>
                <p class="mb-8 text-lg opacity-90 animate-fade-right animate-delay-500">Por medio de experiencias de
        ...
        <div class="mx-4 mt-4 bg-gradient-to-l from-blue-500 to-blue-600 rounded-3xl">
          <div class="container flex items-end py-8 mx-auto space-x-7">
            <div class="w-7/10">
              ...
              <p class="text-gray-100">Al registrarse podrá comentar, indagar y responder comentarios acerca de las
            ...
            <div class="flex p-2 py-6 mt-4 bg-rose-700 rounded-xl">
              <div class="flex flex-col gap-2 items-center w-1/2">
                ...
                <p class="text-white">Es un sitio web, de registro gratuito, el cual almacena las experiencias de
                  ...
                  y ayudar a tomar las mejores decisiones.</p>
                <RouterLink :to="{ name: 'nosotros' }" class="px-6 py-2 text-black bg-white rounded-lg shadow my">
        ...
        <div class="bg-[#f0f0f0]">
          ...
          <div class="py-8 text-center">
            <h2 class="text-2xl font-bold text-gray-800">Recopilación de comentarios y experiencias de personas que han
              sido víctimas del fraude y estafas</h2>
            <p class="px-6 text-gray-600">Todos los comentarios que podrás visualizar, responder y comentar, han sido de
              experiencias que pueden ayudarle a prevenir la misma situación y tomar una decisión diferente</p>
          </div>
        </div>
        ...
        <div class="container flex justify-center items-center mx-auto w-full">
          <div class="w-2/5">
            ...
            <p class="text-gray-600">Al tener una recopilación se puede detectar a los estafadores y podrá actuar
              legalmente contra ellos</p>
            <div class="mt-4">
              <p class="font-bold text-gray-800">¡Próximamente...! <i class="fas fa-balance-scale"></i></p>
            </div>
            <p class="text-gray-600">Ofreceremos asesorías jurídicas gratuitas en el sitio para apoyo de las víctimas en
              los casos de Estafas y Fraudes</p>
          </div>
          <img src="../assets/img/contrato.png" alt="Contrato" class="w-2/4 h-auto rounded-2xl">
        </div>
                ...
                <div class="container px-4 mx-auto">
                  ...
                  <div class="mx-auto mb-16 max-w-2xl text-center">
                    ...
                    <p class="text-gray-600">
                      ...
                      comunes y aparecen en los comentarios.
                    </p>
                  </div>

                  <!-- Grid de Tipos de Estafas -->
                  <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <h3 class="mb-4 text-xl font-bold">
                          <i class="mr-2 text-blue-500 fas fa-file-contract"></i>
                          Hipotecario
                        </h3>
                        <p class="mb-4 text-gray-600">
                          Venta o renta de un inmueble, el cual puede tener los siguientes problemas de fraude:
                          Documentación ilegítima, deudas y/o procesos legales, ventas/rentas con robo de identidad,
                          inmueble dañado o no cumple con las características mencionadas.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <h3 class="mb-4 text-xl font-bold">
                          <i class="mr-2 text-purple-500 fas fa-globe"></i>
                          Compras por Internet
                        </h3>
                        <p class="mb-4 text-gray-600">
                          Las compras en línea se han convertido en uno de los puntos más fuertes hablando de fraudes y
                          estafas. En la compra en línea se pueden ver los siguientes problemas: Producto erróneo,
                          defectuoso, usado, sin garantía, robo de dinero, entre muchos otros.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <h3 class="mb-4 text-xl font-bold">
                          <i class="mr-2 text-green-500 fas fa-tools"></i>
                          Servicios
                        </h3>
                        <p class="mb-4 text-gray-600">
                          Los servicios dan publicidad engañosa, manejan un precio con ciertos beneficios, pero con
                          ciertas condiciones que obstruyen para tener las garantías prometidas. Los problemas e
                          incidentes más comunes son: Precio por tiempo limitado, no cumplen con los beneficios, aumento
                          de precio constantemente, contratos engañosos y más.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <h3 class="mb-4 text-xl font-bold">
                          <i class="mr-2 text-red-500 fas fa-tags"></i>
                          Productos
                        </h3>
                        <p class="mb-4 text-gray-600">
                          Existen diversidad de productos, ya sea en comida, tecnología, belleza, salud, entre otros.
                          Cada uno maneja ciertos beneficios, pero algunos no cumplen con lo que mencionan. Los
                          productos regularmente realizan este tipo de estafas: Utilidad y resultados no correctos como
                          se promete, compras falsas donde nunca llega el pedido, ingredientes y/o materiales no
                          auténticos como se promociona, entre otros.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <h3 class="mb-4 text-xl font-bold">
                          <i class="mr-2 text-yellow-500 fas fa-landmark"></i>
                          Bancarios o Prestamistas
                        </h3>
                        <p class="mb-4 text-gray-600">
                          En esta parte existen estafas de las dos partes, como el que solicita el préstamo y el
                          prestamista. Algunos contratos son engañosos y confusos para realizar otro tipo de cargo,
                          aumento de intereses entre otros. Y su contraparte, hace promesas falsas para posteriormente
                          no pagar.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div class="p-6">
                        <h3 class="mb-4 text-xl font-bold">
                          <i class="mr-2 text-indigo-500 fas fa-user-tie"></i>
                          Trabajos
                        </h3>
                        <p class="mb-4 text-gray-600">
                          Existen trabajos o empleos que no son lo que parecen, estafan a las personas con falsas
                          ofertas de empleo como lo son: Engaños ofreciendo sueldos y áreas que no se cumplen, solicitan
                          dinero para comprar producto o requerimiento para continuar con los filtros, pruebas de
                          compromiso o fidelidad donde se incluye dinero, tiempo y diferentes recursos.
                        </p>
                      </div>
                      <RouterLink :to="{ name: 'blog' }"
        ...
        <div class="container px-4 py-20 mx-auto">
            <div class="flex items-center">
                <div class="w-full md:w-1/2 lg:pr-20">
                    ...
                    <p class="mb-8 text-lg opacity-90">Comunidad colaborativa contra estafas y fraudes digitales</p>
                    <p class="mb-8 text-lg opacity-90">Por medio de experiencias de terceros, podrás saber por sus comentarios si una persona, empresa o servicio comete estafa o fraude</p>
                    <div class="flex gap-4 mb-12">
                        <RouterLink
                            :to="{name:'home'}"
                    ...
                    <div class="p-6 bg-sky-400 rounded-xl backdrop-blur-sm bg-white/5">
                        <div class="flex gap-4 items-center">
                            ...
                            <div class="w-20">
                                <img src="../assets/img/security-badge.png" alt="Escudo de seguridad" class="w-full">
                            </div>
                        </div>
                    </div>
                </div>
...
onMounted(() => {
  uiValues().setMainSectionHeight(document.getElementById('mainSectionHeader').offsetHeight)
})
